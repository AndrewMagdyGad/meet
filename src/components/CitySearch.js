  ...
  const handleInputChanged = (event) => {
    ...
    const filteredLocations = allLocations
      ? allLocations.filter((location) => {
          return location.toUpperCase().indexOf(value.toUpperCase()) > -1; // Filter locations that match the input value
        })
      : [];
  ...
  return (
    <div id="city-search">
      ...
      <input
        ...
        onChange={handleInputChanged} // Handle input changes with handleInputChanged function
      />
